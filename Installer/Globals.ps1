...
$global:BaseConfigPath = "$($global:ScriptDirectory)\Payload\Config\BaseConfig.glconfig"
...
$global:LangTextProvidedSettingHasNoValueMessageBoxCaption = "BaseConfig.glconfig error"
